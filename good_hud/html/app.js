...
window.onload = function () {
		...
		var eventCallback = {
			ui: function(data) {
				...
				else if (config.showServerLogo == false) { document.querySelector('.info.player').style.top = '70px'; }
			...
			elementValue: function(data) {
				document.querySelector('#'+data.el).innerHTML = data.value;
			},
