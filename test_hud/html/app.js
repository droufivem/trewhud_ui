...
window.onload = function () {
		...
		var eventCallback = {
			ui: function(data) {
				...
				if (config.showMafiaSocietyMoney == true) { document.querySelector('#mafiasociety').style.display = 'block'; }
				...
				if (config.showMafiaJob == true) { document.querySelector('#mafiajob').style.display = 'block'; }
