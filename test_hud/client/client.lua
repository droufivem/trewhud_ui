...
Citizen.CreateThread(function()
	...
	while ESX.GetPlayerData().job == nil or ESX.GetPlayerData().mafiajob == nil do
		Citizen.Wait(10)
	end
...
AddEventHandler('trew_hud_ui:setInfo', function(info)
	...
	SendNUIMessage({ action = 'setText', id = 'mafiajob', value = info['mafiajob'] })
	...
	if ESX.PlayerData.mafiajob ~= nil then
		if ESX.PlayerData.mafiajob.grade_name ~= nil and (ESX.PlayerData.mafiajob.grade_name == 'boss') then
			if (Config.ui.showMafiaSocietyMoney == true) then
				SendNUIMessage({ action = 'element', task = 'enable', value = 'mafiasociety' })
			end
		else
			SendNUIMessage({ action = 'element', task = 'disable', value = 'mafiasociety' })
		end
	end
...
RegisterCommand('hudsettings', function()
    if not hud then  
      ...
      local elements = {
	 {label = " ðŸ’¼ JOB SETTINGS ðŸ’¼ ", value = "0"},		  
     {label = "Disable MafiaJob", value = "doubl"},
     {label = "Enable MafiaJob", value = "doubl1"},
	 {label = "Disable Job", value = "hud"},
     {label = "Enable Job", value = "hudtick"},
	{label = " ðŸ’¸ MONEY SETTINGS ðŸ’¸ ", value = "0"},		  
	 {label = "Disable Wallet", value = "wlt"},
	 {label = "Enable Wallet", value = "wlt1"},
	 {label = "Disable BlackMoney", value = "blc"},
     {label = "Enable BlackMoney", value = "blc1"},
	 {label = "Disable Bank", value = "bnk"},
     {label = "Enable Bank", value = "bnk1"},
	 {label = " âœ¨ ALL SETTINGS âœ¨ ", value = "0"},		  
	 {label = "Remove All", value = "del"},
	 {label = "Restart All", value = "res"},
    }
  ...
  ESX.UI.Menu.Open("default", GetCurrentResourceName(), "identity_menu", {
   ...
   if data.current.value == "hud" then
      SendNUIMessage({ action = 'element', task = 'disable', value = 'job' })
   elseif data.current.value == "hudtick" then
      SendNUIMessage({ action = 'element', task = 'enable', value = 'job' })
   elseif data.current.value == "doubl" then
	  SendNUIMessage({ action = 'element', task = 'disable', value = 'mafiajob' })
   elseif data.current.value == "doubl1" then
		SendNUIMessage({ action = 'element', task = 'enable', value = 'mafiajob' })
   elseif data.current.value == "wlt" then
      SendNUIMessage({ action = 'element', task = 'disable', value = 'wallet' })
   elseif data.current.value == "wlt1" then
      SendNUIMessage({ action = 'element', task = 'enable', value = 'wallet' })
   elseif data.current.value == "blc" then
		SendNUIMessage({ action = 'element', task = 'disable', value = 'blackMoney' })
   elseif data.current.value == "blc1" then
		SendNUIMessage({ action = 'element', task = 'enable', value = 'blackMoney' })
   elseif data.current.value == "bnk" then
		SendNUIMessage({ action = 'element', task = 'disable', value = 'bank' })
   elseif data.current.value == "bnk1" then
		SendNUIMessage({ action = 'element', task = 'enable', value = 'bank' })
   elseif data.current.value == "res" then
	...
	SendNUIMessage({ action = 'element', task = 'enable', value = 'sranje' })
	SendNUIMessage({ action = 'element', task = 'enable', value = 'pisanje' })
   elseif data.current.value == "del" then
	...
	SendNUIMessage({ action = 'element', task = 'disable', value = 'sranje' })
	SendNUIMessage({ action = 'element', task = 'disable', value = 'pisanje' })
